...
def calculate_qa_metrics(benchmark_folder: str, filename: str):
    """Calculate QA metrics for a JSON file using m_flow evaluation framework."""
    import json
    import os
    import asyncio
    import m_flow
    from m_flow.eval_framework.evaluation.run_evaluation_module import run_evaluation
    from m_flow.eval_framework.eval_config import EvalConfig
    ...
    try:
        ...
        print(f"  - Deepeval: {deepeval_filename}")
        print(f"  - DirectLLM: {directllm_filename}")
